...
ECHO Step 1 of 4: Checking for Python installation...
CALL :FindPython
...
ECHO Step 2 of 4: Checking for 7-Zip installation...
...
ECHO Step 3 of 4: Installing Python libraries...
...
:: Step 4: Download TeamTalk SDK
ECHO Step 4 of 4: Configuring the TeamTalk SDK...
